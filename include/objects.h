...
public:
    ...
    //! The individual asteroid instance totals.
    unsigned int totals[6] = {QUANTITY, QUANTITY, QUANTITY, QUANTITY, QUANTITY, QUANTITY};
    ...
    //! Shader locations.
    string vertexShader = "/usr/share/openglresources/shaders/asteroids.vs";
    string fragmentShader = "/usr/share/openglresources/shaders/asteroids.frag";
